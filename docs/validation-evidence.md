...
themes are: two-way exchange fixtures, offset math, path-delay math, and sign-convention tests. These checks are deliberately modest, but they establish a baseline that
