...
PTP Nanosecond Timestamp Core belongs to the nanosecond market data milestone layer. Its purpose is to compute PTP-style offset and path delay from four timestamp exchanges. The public
