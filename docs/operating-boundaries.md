...
asymmetric paths, clock drift, NIC timestamp placement, and servo control behavior require hardware-specific validation. A serious reviewer should see that this risk is named directly rather than hidden behind
